...
export class EstoniaForm implements CountryStepsInterface {
    Steps = [
        {
            content: [
                {
                    ...
                    options: [
                        { value: 'Tallinn', label: 'Estonya Vize Başvuru Merkezi - Tallinn' },
                        { value: 'Tartu', label: 'Estonya Vize Başvuru Merkezi - Tartu' },
                        { value: 'Narva', label: 'Estonya Vize Başvuru Merkezi - Narva' },
                    ],
                },
                {
                    type: 'select',
            ...
            content: [
                ...
                { type: 'text', name: 'lastName', label: 'Soyisminizi Giriniz', placeholder: 'Soyisminizi Giriniz' },
                {
                    ...
                    options: [
                        ...
                        { value: 'estonian', label: 'Estonyalı' },
